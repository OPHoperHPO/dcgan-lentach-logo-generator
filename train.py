...
# Define classes
class LentachGenerator:
    # RGB-images: 3-channels, grayscale: 1-channel, RGBA-images: 4-channels
    def __init__(self, image_width, image_height, channels, load = False, pretrained_paths=['saved_models/lentach_generator.h5', 'saved_models/lentach_discriminator.h5']):
        ...
        self.discriminator = self.build_discriminator(load=load, path_model=pretrained_paths[1])
        self.discriminator.compile(loss="binary_crossentropy", optimizer=optimizer, metrics=["accuracy"])
        self.generator = self.build_generator(load=load, path_model=pretrained_paths[0])
    ...
    def build_generator(self, load = False, path_model = None):
    ...
    def build_discriminator(self, load = False, path_model=None):
    ...
    def train(self, datafolder, epochs, batch_size, save_images_interval):
        ...
        self.generator.save("saved_models/lentach_generator.h5")
        self.discriminator.save("saved_models/lentach_discriminator.h5")
    ...
    def save_images(self, epoch):
        ...
        self.generator.save("saved_models/lentach_generator_%d.h5" % epoch)
        self.discriminator.save("saved_models/lentach_discriminator_%d.h5" % epoch)
        plt.close()

if __name__ == '__main__':
    facegenerator = LentachGenerator(64, 64, 3, load=False)
    facegenerator.train(datafolder="dataset", epochs=3500, batch_size=32, save_images_interval=50)
